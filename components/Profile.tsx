...
const profileDescription =
  "류성국은 명곡과 봉림의 오늘을 가까이에서 듣고, 주민의 일상에 필요한 변화를 의정활동으로 이어가겠습니다. 작은 민원도 생활의 문제로 보고, 교육·교통·행정·예산을 성실하게 챙기겠습니다.";
    ...
    <section id="profile" className="civic-section bg-white">
      <div className="section-shell">
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <SectionHeading eyebrow="Profile" title={`${site.name}을 소개합니다`} description={profileDescription} />
